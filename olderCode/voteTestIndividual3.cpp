...
int main(int argc, char *argv[])
{
	...
	for(tempPollInputY = 1;tempPollInputY < static_cast<int>(strat_sentinelValue); tempPollInputY++)
	for(tempPairInputY = 1;tempPairInputY < static_cast<int>(pair_sentinelValue); tempPairInputY++)
	for(tempBuildInputY = 1;tempBuildInputY < static_cast<int>(build_sentinelValue); tempBuildInputY++)

...
nice nice ./voteResearch 5 7 1 2 2 3 2 1 1
nice nice ./voteResearch 5 7 1 2 2 3 1 1 1
stage1max=12
stage2max=3
stage3max=3
stage1skip=7
...
stage2done=(2 3)
stage3done=(3)
for ((stage1=3;stage1<=stage1max;stage1++)); do
	for ((stage2=1;stage2<=stage2max;stage2++)); do
		for ((stage3=1;stage3<=stage3max;stage3++)); do
			date
			echo "Running $stage1 $stage2 $stage3"
			contains2=$(containsElement "$stage2" "${stage2done[@]}")
			contains3=$(containsElement "$stage3" "${stage3done[@]}")
			if [[ $contains2 && $contains3 ]]; then
				continue
			fi
			nice nice ./voteResearch 5 7 1 2 "$stage1" "$stage2" "$stage3" 1 1
		done
	done
done

...
#checks victoryPairwise/Leader/Front against all winOrLosePairwise options
...
stage2init=1
stage3init=2
nice nice ./voteResearch1000 5 1 1 1 12 1 2 1 1
#run another sincere vs winOrLosePairwise, for good measure.
for ((stage1=12;stage1<=stage1max;stage1++)); do

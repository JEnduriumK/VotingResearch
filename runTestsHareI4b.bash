...
#nice ./voteResearch 5 7 1 2 7 1 2 1 3
#nice ./voteResearch 5 7 1 2 7 1 2 2 3
...
# for ((stage2=1;stage2<=stage2max;stage2++)); do
	# for ((stage3=1;stage3<=stage3max;stage3++)); do
		...
		# nice ./voteResearch 5 7 1 2 "$stage1" "$stage2" "$stage3" 2 1
	# done
# done
stage1=10
nice ./voteResearch 5 7 1 2 10 2 2 2 1
nice ./voteResearch 5 7 1 2 10 2 3 2 1
for ((stage2=3;stage2<=stage2max;stage2++)); do
	for ((stage3=1;stage3<=stage3max;stage3++)); do
		date
		echo "Running $stage1 $stage2 $stage3"
		nice nice ./voteResearch 5 7 1 2 "$stage1" "$stage2" "$stage3" 2 1
	done
done

...
stage3init=1
stage3=1
#nice nice ./voteResearch1000 1 1 1 1 2 2 1 1 1

#run another sincere vs winOrLosePairwise prioritizeRunnerUp for good measure
...
for ((stage2=1;stage2<=stage2max;stage2++)); do
	...
	nice nice ./voteResearch1000 1 "$stage1init" "$stage2init" "$stage3init" "$stage1" "$stage2" "$stage3" 1 1
done

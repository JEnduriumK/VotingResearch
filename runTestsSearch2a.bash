...
#checks victoryPairwise/Leader/Front against all other victoryPairwise options
...
stage2init=1
stage3init=2
nice nice ./voteResearch1000 5 1 1 1 11 1 2 1 1
#run another sincere vs victoryPairwise, for good measure.
for ((stage1=11;stage1<=stage1max;stage1++)); do
